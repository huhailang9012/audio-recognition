...
# TABLE AUDIOS
AUDIOS_TABLE_NAME = "audios"

# AUDIOS FIELDS
FIELD_AUDIO_ID = 'audio_id'
FIELD_AUDIO_NAME = 'audio_name'
...
# TABLE MATCHED_AUDIOS
MATCHED_AUDIOS_TABLE_NAME = "matched_audios"

# MATCHED_AUDIOS FIELDS
FIELD_MATCHED_AUDIO_ID = 'id'
FIELD_MATCHED_AUDIO_NAME = 'name'
FIELD_MATCHED_AUDIO_FILE_MD5 = "md5"
FIELD_MATCHED_AUDIO_RELATED_KEY = "related_key"
FIELD_MATCHED_AUDIO_FORMAT = 'format'
FIELD_MATCHED_AUDIO_STORAGE_PATH = 'storage_path'
FIELD_MATCHED_AUDIO_DATE_CREATED = 'date_created'

# TABLE MATCHED_INFORMATION
MATCHED_INFORMATION_TABLE_NAME = "matched_information"
...
FIELD_MATCHED_INFORMATION_AUDIO_MD5 = "audio_md5"
...
FIELD_MATCHED_INFORMATION_ALIGN_TIME = 'align_time'
FIELD_MATCHED_INFORMATION_DATE_CREATED = 'date_created'

# TABLE MATCHED_INFORMATION
RELATED_AUDIOS_TABLE_NAME = "related_audios"

# RELATED_AUDIOS FIELDS
FIELD_RELATED_AUDIOS_ID = 'id'
FIELD_RELATED_AUDIOS_AUDIO_ID = 'audio_id'
FIELD_RELATED_AUDIOS_RELATED_AUDIO_ID = "related_audio_id"
FIELD_RELATED_AUDIOS_RELATED_AUDIO_NAME = "related_audio_name"
FIELD_RELATED_AUDIOS_MATCHED_ID = 'matched_id'
FIELD_RELATED_AUDIOS_INPUT_TOTAL_HASHES = 'input_total_hashes'
FIELD_RELATED_AUDIOS_FINGERPRINTED_HASHES_IN_DB = 'fingerprinted_hashes_in_db'
FIELD_RELATED_AUDIOS_HASHES_MATCHED_IN_PUT = 'hashes_matched_in_input'
FIELD_RELATED_AUDIOS_INPUT_CONFIDENCE = 'input_confidence'
FIELD_RELATED_AUDIOS_FINGERPRINTED_CONFIDENCE = 'fingerprinted_confidence'
FIELD_RELATED_AUDIOS_OFFSET = 'offset'
FIELD_RELATED_AUDIOS_OFFSET_SECONDS = 'offset_seconds'
FIELD_RELATED_AUDIOS_FILE_SHA1 = 'file_sha1'
# FINGERPRINTS CONFIG:
