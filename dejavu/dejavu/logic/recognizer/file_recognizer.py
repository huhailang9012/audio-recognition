...
class FileRecognizer(BaseRecognizer):
    ...
    def recognize_file(self, filename: str) -> Dict[str, any]:
        ...
        file_sha1 = decoder.unique_hash(filename)
        name = os.path.basename(filename)
        auido_id = uuid.uuid1().hex
        self.dejavu.db.insert_matched_audios(auido_id,name, file_sha1, "aac", filename)
        ...
        self.dejavu.db.insert_matched_information(match_id,auido_id, t, fingerprint_time, query_time, align_time)
